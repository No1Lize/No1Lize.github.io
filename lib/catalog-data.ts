...
export const companies: Company[] = [
  ...
  { slug:"sambanova", name:"SambaNova Systems", region:"美国", sector:"半导体", stage:"成长期", status:"运营中", founded:"2017", headquarters:"California", summary:"提供企业级 AI 芯片、系统和模型服务。", product:"DataScale 系统与企业 AI 云。", source:official("SambaNova","https://sambanova.ai/about"), confidence:0.94 },
...
export const reports = [
  ...
  { slug:"source-discipline", type:"方法报告", title:"创投情报的信源分级、冲突保存与去重方法", summary:"解释本站如何在多来源报道中确定主值并保留披露差异。", date:"2025-05-01", sources:6, tags:["方法","信源"] },
];
...
export const people: Person[] = [
  ...
  },
  {
    ...
    materials:[
      ...
      {title:"Poor Charlie's Almanack foreword/context",date:"2005",type:"authored_work",url:"https://www.stripe.press/poor-charlies-almanack",source:"Stripe Press"},
    ],
  },
];
